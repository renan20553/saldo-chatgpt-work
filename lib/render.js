...
export function render(state) {
  ...
  $('identity').textContent = state.identity ? `${state.identity.label}\nWorkspace consultado: ${state.identity.workspace}` : 'Conta e workspace ainda não confirmados';
